...
import Header_Nav from "./Nav.jsx";
        ...
        <div className="footer__content padding">
          <div className="footer__sections">
            ...
            <div className="footer__section__two">
              <div className="column first">
                <p className="column__title">Продукт</p>
                <div className="column__list">
                  <a className="column__anchor">Завантажити</a>
                  <a className="column__anchor">Nitro</a>
                  <a className="column__anchor">Стан</a>
                </div>
              </div>
              <div className="column">
                <p className="column__title">Про компанію</p>
                <div className="column__list">
                  <a className="column__anchor">Про нас</a>
                  <a className="column__anchor">Робота</a>
                  <a className="column__anchor">Бренд</a>
                  <a className="column__anchor">Новини</a>
                </div>
              </div>
              <div className="column">
                <p className="column__title">Ресурси</p>
                <div className="column__list">
                  <a className="column__anchor">Коледж</a>
                  <a className="column__anchor">Підтримка</a>
                  <a className="column__anchor">Безпека</a>
                  <a className="column__anchor">Блог</a>
                  <a className="column__anchor">Зворотній зв'язок</a>
                  <a className="column__anchor">Створити</a>
                  <a className="column__anchor">StreamKit</a>
                  <a className="column__anchor">Автори</a>
                  <a className="column__anchor">Спільнота</a>
                </div>
              </div>
              <div className="column">
                <p className="column__title">Політика</p>
                <div className="column__list">
                  <a className="column__anchor">Умови</a>
                  <a className="column__anchor">Конфіденційність</a>
                  <a className="column__anchor">Налаштування cookie</a>
                  <a className="column__anchor">Поради</a>
                  <a className="column__anchor">Подяки</a>
                  <a className="column__anchor">Ліцензії</a>
                  <a className="column__anchor">Модерація</a>
                  <a className="column__anchor"
                    >Інформація про компанію</a
                  >
                </div>
              </div>
            </div>
          ...
          <div className="bottom__info">
            <img
              ...
              alt="Logo"
            />
            <button className="bottom__btn btn">Завантажити</button>
          </div>
        </div>
      </footer>
    </section>
